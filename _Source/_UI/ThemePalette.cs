...
{
	// Define your custom colors using Hex, RGB, or HSV
	public static readonly Color Yellow = Color.FromHtml("#ECE295");
	public static readonly Color Red = Color.FromHtml("#F39183");
